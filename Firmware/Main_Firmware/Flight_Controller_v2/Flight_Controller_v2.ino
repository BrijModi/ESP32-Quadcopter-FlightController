...
uint32_t LoopTimer;
float t = 0.010; 
// t = 0.010 Loop time (≈100Hz)
// t = 0.008 Loop time (~125Hz) or (Faster, more load)
// t = 0.012 Loop time (~83Hz) (Slower, less load)
...
void setup(void) {
  ...
  // IMU calibration offsets (from IMU_Calibration.ino)

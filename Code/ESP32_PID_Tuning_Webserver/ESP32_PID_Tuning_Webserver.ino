...
float IRateRoll = 0.021;
float DRateRoll = 0.012;

float PAngleRoll = 3.8;
float IAngleRoll = 0.021;
float DAngleRoll = 0.032;
...
<body>
  ...
  <h2>ESP32 WiFi PID Tuning Panel</h2>

  <div class="container">

    <div class="section">
      <h3>Rate PID (Roll & Pitch)</h3>

      <form action="/get" target="hidden-form">
        <div class="row">
          <label>P Rate <span class="current">(Current: %pGain%)</span></label>
          <input type="number" name="pGain" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>

      <form action="/get" target="hidden-form">
        <div class="row">
          <label>I Rate <span class="current">(Current: %iGain%)</span></label>
          <input type="number" name="iGain" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>D Rate <span class="current">(Current: %dGain%)</span></label>
          <input type="number" name="dGain" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
    </div>
    ...
    <div class="section">
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>P Angle <span class="current">(Current: %pAGain%)</span></label>
          <input type="number" name="pAGain" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>I Angle <span class="current">(Current: %iAGain%)</span></label>
          <input type="number" name="iAGain" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>D Angle <span class="current">(Current: %dAGain%)</span></label>
          <input type="number" name="dAGain" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
    </div>
    ...
    <div class="section">
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>P Yaw <span class="current">(Current: %pYaw%)</span></label>
          <input type="number" name="pYaw" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>I Yaw <span class="current">(Current: %iYaw%)</span></label>
          <input type="number" name="iYaw" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>D Yaw <span class="current">(Current: %dYaw%)</span></label>
          <input type="number" name="dYaw" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
    </div>
    ...
    <div class="section">
      ...
      <form action="/get" target="hidden-form">
        <div class="row">
          <label>Loop Time (t) <span class="current">(Current: %tc%)</span></label>
          <input type="number" name="tc" step="any">
          <button onclick="submitMessage()">Set</button>
        </div>
      </form>
    </div>
